...
class EnterpriseSearchEvidence:
    ...
    def _policy(cls, raw: Any) -> dict[str, Any]:
        ...
        return {
            ...
            "max_age_seconds": cls._number(raw.get("max_age_seconds", 86400.0), "policy_max_age_seconds", minimum=0.0),
            ...
            "max_contradicted_units": cls._integer(raw.get("max_contradicted_units", 0), "policy_max_contradicted_units", minimum=0),
        }
    ...
    def _hit(
        ...
        *,
        ...
        if unknown_units:
            raise ValueError(f"hit_{index}_unknown_claim_units:" + ",".join(sorted(unknown_units)))
        ...
        eligible = entitled and fresh and score_ok
        return {
    ...
    def evaluate(self, req: EnterpriseSearchEvidenceRequest) -> EnterpriseSearchEvidenceReceipt:
        ...
        try:
            ...
            claim_units_list = self._text_list(
                payload.get("claim_units"), "claim_units", limit=self.MAX_UNITS, allow_empty=False
            )
            ...
            if work_units > budget:
                ...
                result = {
                    ...
                    "inaccessible_hit_count": sum(not hit["entitled"] for hit in hits),
